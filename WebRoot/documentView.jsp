		...
		<div style="position: absolute; left: 50px; top: 10px;">
			...
			<script type="text/javascript"> 
				var fp = new FlexPaperViewer(	
						 ...
						 { 
						 config : {
						 SwfFile : decodeURI('<%=swfFilePath%>'), //编码设置 这里是要显示的swf的位置，相对根目录
						 Scale : 0.6, //缩放比例
						 ...
						 ZoomInterval : 0.2,//(原来0.2)缩放滑块-移动的缩放基础[工具栏] //缩放比例之间间隔，默认值为0.1，该值为正数。
						 FitPageOnLoad : true,//(原来true)自适应页面 //初始化的时候自适应页面，与使用工具栏上的适应页面按钮同样的效果。
						 FitWidthOnLoad : true,//(原来true)自适应宽度
						 FullScreenAsMaxWindow : false,//全屏按钮-新页面全屏[工具栏]
						 ProgressiveLoading : false,  //(原来写的false)分割加载
						 MinZoomSize : 0.2,//最小缩放
						 MaxZoomSize : 3,//(3)最大缩放
						 SearchMatchAll : true,
